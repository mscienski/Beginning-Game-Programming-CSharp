...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //the first rock is a random rock
            rock0 = GetRandomRock();
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedDelayMilliseconds >= TOTAL_DELAY_MILLISECONDS)
            {
                ...
                //Each second, spawn a rock until all 3 exists
                if (rock0 == null)
                {
                    rock0 = GetRandomRock();
                }
            ...
            //Every update, which is more often than once a second, check the outside window property of existing rocks, and re-initialize them if the sprites are outside
        ...
        private Texture2D GetRandomSprite()
        {
            ...
            // a random sprite
            //we have 3 sprites, so random between 0 and 3.
        ...
        private Vector2 GetRandomVelocity()
        {
            // STUDENTS: Uncommment and modify the code below as appropriate to return 
            // a random velocity
            //there are 4 directions, so random between 0 and 4
