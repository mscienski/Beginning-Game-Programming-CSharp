...
namespace ProgrammingAssignment4
{
    ...
    public class Teddy
    {
        ...
        public Teddy(Texture2D sprite, Vector2 location)
        {
            ...
            this.drawRectangle = new Rectangle((int)(location.X - this.sprite.Width / 2), (int)(location.Y - this.sprite.Height/2), this.sprite.Width, this.sprite.Height);

            // STUDENTS: set halfDrawRectangleWidth and halfDrawRectangleHeight for efficiency
            halfDrawRectangleWidth = this.drawRectangle.Width / 2;
            halfDrawRectangleHeight = this.drawRectangle.Height / 2;
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            if (this.collecting)
            {
                this.location.X += this.velocity.X * gameTime.ElapsedGameTime.Milliseconds;
                this.location.Y += this.velocity.Y * gameTime.ElapsedGameTime.Milliseconds;

                this.drawRectangle.X = (int)(this.location.X - halfDrawRectangleWidth);
                this.drawRectangle.Y = (int)(this.location.Y - halfDrawRectangleHeight);
            }
        ...
        public void SetTarget(Vector2 target)
        {
            ...
            // speed
            Vector2 updatedVelocity = target - this.location;
            updatedVelocity.Normalize();
            this.velocity = updatedVelocity * BASE_SPEED;
